...
The name 'identifier' does not exist in the current context
 ...
 An attempt was made to use a name that does not exist in the class, [namespace](../keywords/namespace.md), or scope. Check the spelling of the name and check you are using directives and assembly references to make sure that the name that you are trying to use is available.
